...
#print("*     ====================== Version 0.6 for macOS ======================     *")
#print("*     ====================== Version 0.6 for Linux ======================     *")
#print("*     ================ Version 0.6 for Microsoft Windows ================     *")
print("*                           Last update: 2021-07-02                           *")
print("*                                                                             *")
...
print('Please choose the new input file type:')
...
if userInputInt == 4:
	ginpFileName = input("Please specify the path to O2I input file:\n")
